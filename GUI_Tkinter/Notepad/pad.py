...
def About():
    ...
    a.geometry("1327x420")
    a.title("About")
    a.wm_iconbitmap("F:\\Python\\GUI_Tkinter\\Notepad\\dist\\icon.ico")
...
def More_Help():
    ashok = Tk()
    ashok.wm_iconbitmap("F:\\Python\\GUI_Tkinter\\Notepad\\dist\\icon.ico")
...
def feedback():
    def send():
        ...
        if ask > 0:
            ...
            s.wm_iconbitmap("F:\\Python\\GUI_Tkinter\\Notepad\\dist\\icon.ico")
            s.geometry("856x200")
    ...
    feed.wm_iconbitmap("F:\\Python\\GUI_Tkinter\\Notepad\\dist\\icon.ico")
...
if __name__ == '__main__':
    ...
    root.iconbitmap("F:\\Python\\GUI_Tkinter\\Notepad\\dist\\icon.ico")
    root.title("Untitled - Notepad")
