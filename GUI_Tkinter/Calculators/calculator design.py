...
def feedback():
    ...
    def send():
        ...
        if ask > 0:
            ...
            Button(s, text="Exit", bg="Dark Green", fg="White", font=("Eras Bold ITC", 22, "bold"), bd=10,
